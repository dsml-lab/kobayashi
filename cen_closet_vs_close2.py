...
def main():
    ...
    try:
        ...
        try:
            ...
            base_alpha_csv_dir = f"./alpha_test/seed/width_1/lr_0.2/ori_closet_{experiment_name}/{mode1}_{mode2}/{label_y_clean}/{label_x_noisy}"
            # ユニークなディレクトリパスを取得
        ...
        for epoch in range(0, args.epoch + 1):
            checkpoint_path = f"save_model/Colored_EMSNIT/noise_rate=0_sigma=0/{experiment_name}/model_epoch_{epoch}.pth"
    ...
    #target_plot_probabilities(alpha_csv_dir, targets="combined", gif=True,show_legend=False, gif_output=f"combined.gif", epoch_start=0, epoch_end=1000, epoch_step=10)
    clear_memory()
