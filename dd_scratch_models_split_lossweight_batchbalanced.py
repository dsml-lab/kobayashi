...
def parse_args():
    ...
    arg_parser.add_argument("-wandb_project", "--wandb_project", type=str, default="kobayshi_color_mnist", help="wandbのプロジェクト名")
...
def main():
    ...
    try:
        ...
        experiment_name = (
            ...
            f'cleanw{args.weight_clean}_noisew{args.weight_noisy}_variance{args.variance}'
        )
