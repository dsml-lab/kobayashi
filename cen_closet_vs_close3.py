...
def main():
    ...
    try:
        ...
        try:
            ...
            base_alpha_csv_dir = f"./alpha_test/seed/width_cus_10/lr_0.2/ori_closet_{experiment_name}/{mode1}_{mode2}/{label_y_clean}/{label_x_noisy}"
            # ユニークなディレクトリパスを取得
        ...
        for epoch in range(0, args.epoch + 1):
            checkpoint_path = f"save_model/Colored_EMSNIT/seed_lr_0/{experiment_name}/model_epoch_{epoch}.pth"
