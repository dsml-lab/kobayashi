...
def main():
    ...
    os.makedirs(f"./csv/{experiment_name}", exist_ok=True)
    with open(f"./csv/{experiment_name}/log.csv", 'a') as f:
        writer = csv.writer(f)
    ...
    for epoch in range(args.epoch):
        ...
        os.makedirs(f"./model_weights/{experiment_name}", exist_ok=True)
        torch.save(model.state_dict(), f"./model_weights/{experiment_name}/model_{epoch}.pth")
