...
def main():
    ...
    try:
        ...
        try:
            idx_noisy = 74953  # 適切なインデックスを指定
            idx_clean = 75911  # 適切なインデックスを指定
            ...
            base_alpha_csv_dir = f"./alpha_test/seed/lr_{args.label_noise_rate}/ori_closet_{experiment_name}/{mode1}_{mode2}/{label_y_clean}/{label_x_noisy}"            # ユニークなディレクトリパスを取得
